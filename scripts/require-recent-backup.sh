#!/usr/bin/env bash
# Valide l'attestation de sauvegarde FAB avant une opération destructive.
# Le helper root GestionVPS vérifie le marqueur signé et la preuve distante;
# aucune clé ou configuration hors site n'est lue par ce dépôt.
